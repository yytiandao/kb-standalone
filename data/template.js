/* template.js  —— 实战模板
 * 由 admin.html 导出生成；包含的表: KB_TEMPLATE
 * 手改也欢迎，格式就是 window.<表名> = <JSON>; */

window.KB_TEMPLATE = [
 {
  "id": "npi",
  "icon": "<svg class=ic aria-hidden=true><use href=#i-rocket /></svg>",
  "name": "NPI 新品开发流程",
  ...
  "blocks": [
   ...
   },
   {
    ...
    "rows": [
     ...
     [
      "② 方案设计",
      "结构方案、选材、初步堆叠、光学/散热方案",
      "结构方案图、关键器件选型表、DFM 预检",
      "方案评审（怎么做）",
      "只算空间不算公差，装配时才知装不进"
     ],
     [
      "③ 详细设计",
      "3D 建模、出 2D 图、公差标注、DFM 检讨",
      "全套图纸、BOM、DFM 检讨记录",
      "开模评审（可制造性）",
      "图纸漏标基准与关键尺寸，模厂自由发挥"
     ],
  ...
  "blocks": [
   ...
   },
   {
    ...
    "fields": [
     {
      "l": "会议结论摘要",
      "ph": "本次检讨共 20 项，需改模 X 项，预计 X 个工作日"
     },
     {
      "l": "下一步",
      "ph": "谁在什么时候前交出什么"
     ...
     {
      "l": "双方签字",
      "ph": "结构：__________　模具：__________　日期：__________"
     }
    ]
   }
  ]
